...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  const description = `Security scan: ${scan.summary.total} findings (${scan.summary.critical} critical, ${scan.summary.high} high, ${scan.summary.medium} medium). Scanned with 35 attack modules.`;
